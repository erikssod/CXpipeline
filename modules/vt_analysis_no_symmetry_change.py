...
#This script is for VT analysis with a single reference and NO changes in symmetry
...
ref_INS = Reference_INS(initialise.home_path + '/ref/' + cfg['reference_name'], initialise.home_path)
